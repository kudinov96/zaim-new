...
var _default = /*#__PURE__*/function (_window$Controller) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_this), "example_image_upload_handler", function (blobInfo, progress) {
      return new Promise(function (resolve, reject) {
        var xhr = new XMLHttpRequest();

        var prefix = function prefix(path) {
        ...
        var csrf_token = document.head.querySelector('meta[name="csrf_token"]').getAttribute("content");
  ...
  _createClass(_default, [{
    key: "connect",
    value: function connect() {
      var selector = "#" + this.element.querySelector('.tinymce').id; // For Cache
    ...
    key: "disconnect",
    value: function disconnect(selector) {
      tinymce.remove(selector);
    }
  }]);
...
/******/ 	__webpack_require__.O(undefined, ["front/style"], () => (__webpack_require__("./resources/js/dashboard.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["front/style"], () => (__webpack_require__("./resources/scss/style.scss")))
